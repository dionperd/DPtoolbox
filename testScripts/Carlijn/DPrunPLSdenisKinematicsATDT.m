...
% %---------------------A. Stack PLS matrix----------------------------------
%   Inputs:
RESfolder='C:\Users\vernooij.c\Documents\MATLAB\FCD\Results\PLSresults\ATDT';
%-RESfolder: full path to the folder of results .mat files
PLSmatFolder = 'C:\Users\vernooij.c\Documents\MATLAB\FCD\Results\PLSresults\PLS';
...
Measures = {'at','dt'};%{'P','PS','DOF','logF','H','logV','STD','MSE','MSEn'};%'P','DOF','PS','logV','STD','MSE','logF','H'
%-Measures: a cellstring of the names of measures to be calculated
%                                                                                       P       PS    DOF    logF     H     logV     
MeasOutsStruct = {[1,1,280],[1,1,280]};%{[2048 58],[1 58],[1 58],[47 58],[1 58],[50 58],...
                                                                                        %[50 58],[50 58],[50 58]};
...
%-------------------------B. Run PLS--------------------------------------
%Inputs:
OutputFolder = 'C:\Users\vernooij.c\Documents\MATLAB\FCD\Results\PLSresults\PLS\MeanCntr';
