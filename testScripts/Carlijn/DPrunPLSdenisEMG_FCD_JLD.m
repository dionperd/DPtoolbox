...
% %---------------------A. Stack PLS matrix----------------------------------
%   Inputs:
RESfolder='C:\Users\vernooij.c\Documents\MATLAB\FCD\Results\PLS\EMGPeakJLD';
...
Measures = {'peakAQ','peakQ','peakAH','peakH'};%{'P','PS','DOF','logF','H','logV','STD','MSE','MSEn'};%'P','DOF','PS','logV','STD','MSE','logF','H'
