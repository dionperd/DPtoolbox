...
winRootPath = '\\Mpib10';
macRootPath = '/Volumes';
codePath = {'\\Mpib10\InterBrain\EEGlab_VM\Denis2\Software\DPtoolbox\io'};
...
OutputFolderPath = '\\Mpib11\ibsm1\Denis\SyncDyn\Export';
outputs = {...
    2,     OutputFolderPath, 'VA';...
    };
% 
...
procparam.transform = 'gaborWavelet';
procparam.param = 7;
procparam.convORfft = 'fft';
procparam.flimSteps = [      1                 40                   40];
procparam.fscale = 'LINEAR';
procparam.outputs = { 'complex'};
procparam.codePath = {'\\Mpib10\InterBrain\EEGlab_VM\Denis2\Software\DPtoolbox\Time-Frequency'};
