...
OutputFolder = 'C:\Users\dionperd\Dropbox\Dionysis\PostDocMRS\Results\EEG_PSD_JLD\PLSallParamsTogether\MeanCntr';
...
cd(PLSmatFolder) 
load('PLSmat.mat')
cfgMeasure.scales = cfgMeasure.scales(cfgMeasure.scales>1.004); 
