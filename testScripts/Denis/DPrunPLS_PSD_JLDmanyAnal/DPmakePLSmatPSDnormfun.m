function DPmakePLSmatPSDnormfun(RESfolder,PLSfolder)
...
Measures = {'m','s','k','ma','sa','ka',};%,'norm_m','norm_s','norm_ma','norm_sa'
%-Measures: a cellstring of the names of measures to be calculated
%                   all 4 JLD params   
%                  scales>1.004sec 10 freqs 4 params  
MeasOutsStruct =  {[171 10],[171 10],[171 10],[171 10],[171 10],[171 10]};%{[36 10 4]};[171 10],[171 10],[171 10],[171 10]
