%function DPplotPLS_PSDnormfun(PLSfolder)
...
BrainLVplotOpts.method ='BootsRatios';%'LV';%'BootsRatios';
%threshold for reliability
BrainLVplotOpts.th = 3; %~99% confidence
...
%plotBrainLVs = @(BrainLV,BrainLVBootsRatios,BrainLVplotOpts,Measure,cfgMeasure)plotBrainLVs_2D_PSnorm(BrainLV,BrainLVBootsRatios,BrainLVplotOpts,Measure,cfgMeasure);
%plotBrainLVs = @(BrainLV,BrainLVBootsRatios,BrainLVplotOpts,Measure,cfgMeasure)plotBrainLVs_1D_PSnorm(BrainLV,BrainLVBootsRatios,BrainLVplotOpts,Measure,cfgMeasure);
plotBrainLVs = @(BrainLV,BrainLVBootsRatios,BrainLVplotOpts,Measure,cfgMeasure)plotBrainLVs_1D_PSnorm_freqs(BrainLV,BrainLVBootsRatios,BrainLVplotOpts,Measure,cfgMeasure);
