...
% %---------------------A. Stack PLS matrix----------------------------------
%   Inputs:
RESfolder='C:\data\DATA_Aging_Complexity\Results_PSD_JLD\ResultsFiles';
%-RESfolder: full path to the folder of results .mat files
PLSmatFolder = 'C:\data\DATA_Aging_Complexity\Results_PSD_JLD\PLS\RestEO\Lifespan';
...
%-------------------------B. Run PLS--------------------------------------
%Inputs:
OutputFolder = 'C:\data\DATA_Aging_Complexity\Results_PSD_JLD\PLS\RestEO\Lifespan\Contrast';
...
load('C:\data\DATA_Aging_Complexity\Results_PSD_JLD\PLS\RestEO\Lifespan\Contrast\DesignData.mat')
