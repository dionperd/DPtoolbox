function DPrunPLSdenis_fMRI_FCD_JLD(w)
...
% %---------------------A. Stack PLS matrix----------------------------------
%   Inputs:
RESfolder='C:\Users\CoordAgeEEG\Dropbox/Results/fMRI_FCD_JLD/MJLD';
%-RESfolder: full path to the folder of results .mat files
PLSmatFolder = ['C:\Users\CoordAgeEEG\Dropbox\Results\fMRI_FCD_JLD\PLS\',W];
%-PLSmatFolder: full path to the folder where PLS matrix will be saved
RESstruct = 'JLD';
%-RESstruct: name of the result structure (string)
Conds={['MJLD',W]};%{'RestEC','Odd_nC','Odd_C'};%'RestEC','Odd_nC','Odd_C'
%-Conds: cellstring of the names of conditions
Groups={'YA','MA','OA'};% 'mdo11','mdo12',
...
MeasOutsStruct = {[9,1],[9,1],[9,1],[9,1],[9,1],[9,1],[9,1],[9,1],[9,1]};
...
%-------------------------B. Run PLS--------------------------------------
%Inputs:
OutputFolder = ['C:\Users\CoordAgeEEG\Dropbox\Results/fMRI_FCD_JLD/PLS/',W];
...
Groups = {'YA','MA','OA'};%'YA','OC',
%Groups = {'OwithAlpha','OnoAlpha'};
Conds = {''};%{'Rest','OddnC','OddC'};%
%Behav = {'Age'};
