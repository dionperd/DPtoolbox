function phaseCoupling_start_Within_A(filenum)

cd('//home/mpib/szymanski/CCR/');
%cd('/Volumes/gridmaster2012/Export_0309')
...
[N, Nch, Ntr] = size(data);
cfg.Nch = 21; %%% because its within A
...
save([filename,'_Within_A_PC.mat'],'C','cfg');%'Cmean',

disp([filename,'_Within_A_PC.mat'])
