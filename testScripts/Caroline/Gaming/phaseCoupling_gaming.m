function phaseCoupling_gaming(filenum)

cd('//home/mpib/szymanski/gaming/');
...
for iM = 1:NoutMeasures;
    ...
    %values)
    C.(OutMeasures{iM})=zeros(Ntr,Nloops);
    %Cmean.(OutMeasures{iM})=zeros(1,Nloops);  
end
