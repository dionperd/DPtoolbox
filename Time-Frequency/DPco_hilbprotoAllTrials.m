function [theta,ampl]= DPco_hilbprotoAllTrials(x,cutTails) %,minampl
...
%         cutTails  is the number of points at the ends to be cut off,
...
ht=ht-repmat(mean(ht),[Ncut,1, 1]);  % subtracting the mean value    
