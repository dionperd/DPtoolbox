function [h, hsub] = plotMeanSTD_1D_JLDparamsPerFreq(mean,std,Measure, Colors, Groups, Conds, Ns,cfgMeasure)
...
%     plot(x,mean{iX},'color',Colors{iX},'LineStyle',LineStyle,'linewidth',2);
    ...
    errorbar(x,mean{iX},std{iX},'color',Colors{iX},'LineStyle',LineStyle,'linewidth',2, 'MarkerStyle','*','MarkerSize',5)
