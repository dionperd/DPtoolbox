function handles = distributionPlot_DP(varargin)
...
%                7: draw lines at the 10,50,90 percentiles (no mean)
%                8: draw lines at the 5,50,95 percentiles (no mean)
%                9: draw lines at the 2.5,50,97.5 percentiles (no mean)
%                10: draw lines at the 1,50,99 percentiles (no mean)
%                11: draw lines at the 0.1,50,99.9 percentiles (no mean)
        ...
        if opt.showMM >= 6 %DP change: == to >=
            ...
            switch opt.showMM
                case 6
                    ...
                    md(iData,3,1) = prctile(currentData,75);
                case 7
                    md(iData,2,1) = prctile(currentData,10);
                    md(iData,3,1) = prctile(currentData,90);    
                case 8
                    md(iData,2,1) = prctile(currentData,5);
                    md(iData,3,1) = prctile(currentData,95);
                case 9
                    md(iData,2,1) = prctile(currentData,2.5);
                    md(iData,3,1) = prctile(currentData,97.5);
                case 10
                    md(iData,2,1) = prctile(currentData,1);
                    md(iData,3,1) = prctile(currentData,99);
                case 11
                    md(iData,2,1) = prctile(currentData,0.1);
                    md(iData,3,1) = prctile(currentData,99.9);
            end
            %-----------------------DP change:--------------------------
