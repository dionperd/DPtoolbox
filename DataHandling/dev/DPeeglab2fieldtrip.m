function data = DPeeglab2fieldtrip(ALLEEG, fieldbox, transform)
   
%This function calls the eeglab2fieldtrip function to convert several EEG
%structures of the ALLEEG structure array into an array of fieldtrip/trentool data
%structures.
...
for ii=1:N_EEG;
    ...
    data(ii) = eeglab2fieldtrip(ALLEEG(ii), fieldbox, transform);
