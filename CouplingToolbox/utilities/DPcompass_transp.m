function hc = DPcompass_transp(x,y,distinct_colors,edgealpha,line_style,cax)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%DP%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%if isempty(s),
    h = DPpolar_transp(th,r,distinct_colors,edgealpha,line_style,cax);
%     co = get(cax,'colororder');
%     set(h,'edgecolor',co(1,:))
%else
%    h = polar_transp(cax,th,r,s);
%end
