function [PL c1 c2 dirin nrm1 nrm2 dirpar]=DPcalcPRensemble(phi,fs,phaseTrnsfrm,method,ngrid,or,Nwin,Ntr)
...
[Fcoef1,Fcoef2,f1,f2]=DPco_fexp2(phi(:,1),phi(:,2),or,fs,ngrid,Nwin,Ntr);
