function [out theta1 theta2]=DPco_testprotoco_testproto(theta1,theta2)
...
if min(theta1) < 0
    cprintf('Magenta','WARNING: Negative values of protophase are not allowed! Wraping them to the interval [0 2*pi].\n')
