function [PCI NCI ACI ICI12 ICI21] = DPcalcICensemble(Dphi,T,Dphi0,Nwin,Ntr)
...
% %-Nwin: number of points per trial
...
if Nwin<T
    ...
    cprintf('Magenta',['WARNING: Time window is smaller than one period. Clearing period is adjusted to Nwin=%d time points.\n'],T);
end

%Reshape to separate trials
Dphi=reshape(Dphi,Nwin,Ntr); 
...
Dphi = [Dphi;repmat(Dphi0+pi/10,1,Ntr)]; 
