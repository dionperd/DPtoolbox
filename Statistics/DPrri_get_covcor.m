...
%
function [datamatsvd, datamatsvd_unnorm, datamatcorrs_lst, stacked_smeanmat,  grand_mean] = ... %grand_mean is a DP addition
	DPrri_get_covcor(method, stacked_datamat, stacked_behavdata, num_groups, ...
		num_subj_lst, num_cond, bscan, meancentering_type, cormode, ...
		single_cond_lst, is_observation, num_boot, datamat_reorder, ...
		behavdata_reorder, datamat_reorder_4beh)
   ...
   for g = 1:num_groups
      if ~iscell(num_subj_lst)
         ...
         if isempty(single_cond_lst) | g==1
            ...
            if is_observation & num_boot > 0 & ismember(method,[1 2 4 6 12])
