 ...
 */
FARPROC WINAPI levystabledistributionDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = levystabledistributionDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = levystabledistributionDelayLoadWin32FailureHook;
#endif
