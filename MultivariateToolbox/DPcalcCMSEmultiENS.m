function [CMSE, CSTD] = DPcalcCMSEmultiENS(data,m,r,scales,num_tpts, num_var, num_trial, num_sc,norm,normScale,distFun)  %override, DP excluded this input,
...
% $$$ Inputs:
% $$$   data = time series data in (time variable trial) format
...
for s=1:num_sc;
    ...
    for iSc = 1:sc; %for scale =1 sc we have sc possible ways to course grain
        ...
        CSTDiSc(iSc) = distFun(mean(tempSTD,2));
